<SMTK_AttributeResource Version="3">
  <Definitions>
    <AttDef Type="export" BaseType="operation" Label="Export to ATS" Version="0">
      ...
      <ItemDefinitions>
        <!-- <Resource Name="model" Label="Model" Optional="true" IsEnabledByDefault="false" LockType="DoNotLock" AdvanceLevel="1">
          <Accepts>
        ...
        FileFilters="XML files (*.xml);;All files (*.*)" Version="0">
  ...
  <Views>
    <View Type="Instanced" Title="Export Settings" TopLevel="true"
      FilterByCategory="false" FilterByAdvanceLevel="false">
      <InstancedAttributes>
