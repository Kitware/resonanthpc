...
class BaseWriter:
    ...
    def _render_function(self, parent_elem, function_att):
        ...
        params = function_att.find("variable type")
        ...
        if func_type == "constant":
            ...
            group = function_att.find("tabular-data")
            ...
            group = function_att.find("linear-data")
            y = group.find('y0')
