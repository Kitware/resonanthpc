...
<SMTK_AttributeResource Version="3">
  <Definitions>
    ...
    <AttDef Type="ic-base" BaseType="" Abstract="true" Version="0"></AttDef>
    ...
    <!-- <AttDef Type="ic-scalar-field" BaseType="ic-base" Version="0"> <ItemDefinitions> </ItemDefinitions> </AttDef> -->

    <!-- TODO: Initialization of tensor fields -->
    <!-- <AttDef Type="ic-tensor-field" BaseType="ic-base" Version="0"> <ItemDefinitions> </ItemDefinitions> </AttDef> -->

    <!-- TODO: Initialization from a file -->
    <!-- <AttDef Type="ic-file" BaseType="ic-base" Version="0"> <ItemDefinitions> </ItemDefinitions> </AttDef> -->
